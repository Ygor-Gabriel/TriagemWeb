...
import { InputCpf, InputDate, InputPhone, InputText, InputCOREN, InputUF } from '../InputMask';
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      ...
      try {
        ...
        const setValues = await Axios.post('http://localhost:3331/enfermeiro', values);
        helpers.resetForm();
      ...
      >
        ...
        >
          <CardHeader
            ...
            subheader="Preencha os campos abaixo para adicionar um novo enfermeiro."
            sx={{
              mb: 5,
              textAlign: 'center',
            }}
              ...
              >
                ...
                >
                  <TextField
                    ...
                    error={!!(formik.touched.coren && formik.errors.coren)}
                    helperText={formik.touched.coren && formik.errors.coren}
                    InputProps={{
