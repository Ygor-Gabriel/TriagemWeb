  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, helpers) => {
      ...
      try {
        ...
        const setValues = await Axios.post('http://localhost:3331/medico', values);
        helpers.resetForm();
        router.push('/medico');
      ...
      >
        ...
        >
          <CardHeader
            ...
            subheader="Preencha os campos abaixo para adicionar um novo médico."
            sx={{
              mb: 5,
              textAlign: 'center',
            }}
          ...
          <CardContent sx={{ pt: 0 }}>
            ...
            <Box sx={{ mt: 3, textAlign: 'center', }}>
              ...
              <Typography
                ...
                variant="body2"
              >
                Insira os dados de acesso do medico.
              </Typography>
              <Divider sx={{ my: 3 }} />
            </Box>
            <Box sx={{ mt: 3 }}>
