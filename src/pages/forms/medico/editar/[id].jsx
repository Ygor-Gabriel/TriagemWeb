...
export async function getStaticProps({ params }) {
  const response = await fetch(`http://localhost:3331/medico/${params.id}`);
...
export async function getStaticPaths() {
  const response = await fetch(`http://localhost:3331/medico`);
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      crm: Yup
        ...
        .min(6, 'CRM deve ter no mínimo 6 caracteres'),
      uf: Yup
        .string()
    ...
    onSubmit: async (values) => {
      try {
        await Axios.put(`http://localhost:3331/medico/${dados.id}`, values);
        router.push('/medico');
      } catch (error) {
        console.log(error);
      }
          ...
          <CardContent sx={{ pt: 0 }}>
              ...
              >
                ...
                >
                  ...
                  {formik.touched.crm && formik.errors.crm ? (
                    <Typography color="error">{formik.errors.crm}</Typography>
                  ) : null}
                </Grid>
                <Grid
                  xs={12}
            ...
            >
              ...
              <Typography
                ...
                variant="body2"
              >
                Insira os dados de acesso do médico.
              </Typography>
              <Divider sx={{ my: 3 }} />
            </Box>
            <Box sx={{ mt: 3 }}>
